...
public class Authenticated {
	...
	public JWTtoken authenticateAccount(@Valid @RequestBody RequestLogin loginRequest) throws NotFoundException {
		System.out.println(loginRequest);
		try {
			Authentication authentication = authenticationManager.authenticate(
					new UsernamePasswordAuthenticationToken(loginRequest.getEmailLoign(), loginRequest.getPassword()));
